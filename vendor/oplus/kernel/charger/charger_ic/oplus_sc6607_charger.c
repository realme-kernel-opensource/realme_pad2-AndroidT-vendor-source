...
static void sc6607_charger_detect_init(void)
{
	pr_info("enter\n");
	if (g_chip)
...
void sc6607_charger_detect_release(void)
{
	if (g_chip)
...
static int sc6607_voocphy_reset_voocphy(struct oplus_voocphy_manager *chip)
{
	...
	if (g_chip->chip_id == SC6607_1P0_CHIP_ID)
		...
		sc6607_voocphy_write_byte(chip->client, SC6607_REG_VAC_VBUS_OVP, 0x31); /*Vac ovp 11V,Vbus OVP 10V*/
...
static int sc6607_voocphy_init_device(struct oplus_voocphy_manager *chip)
{
	...
	if (g_chip->chip_id == SC6607_1P0_CHIP_ID)
		...
		sc6607_voocphy_write_byte(chip->client, SC6607_REG_VAC_VBUS_OVP, 0x31); /*Vac ovp 11V	 Vbus_ovp 12V*/
...
static int sc6607_voocphy_svooc_ovp_hw_setting(struct oplus_voocphy_manager *chip)
{
	...
	ret = sc6607_field_write(g_chip, F_VAC_OVP, 0x02);
...
static int sc6607_voocphy_svooc_hw_setting(struct oplus_voocphy_manager *chip)
{
	...
	if (g_chip->chip_id == SC6607_1P0_CHIP_ID)
		...
		ret = sc6607_field_write(g_chip, F_VAC_OVP, 0x03); /*VAC_OVP:12v VBUS_OVP:10v*/
	ret = sc6607_field_write(g_chip, F_VBUS_OVP, 0x01);
...
static int sc6607_voocphy_pdqc_hw_setting(struct oplus_voocphy_manager *chip)
{
	...
	if (g_chip->chip_id == SC6607_1P0_CHIP_ID)
		...
		ret = sc6607_field_write(g_chip, F_VAC_OVP, 3); /*VAC_OVP:12v VBUS_OVP:10v*/
